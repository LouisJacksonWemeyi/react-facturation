...
function EnregistreFacturePayeModal(props) {
  const message = (
    <div class="alert alert-warning">
      ...
      <p class="text-info">
        <b>
          Cette action entraîne l'enregistrement de la facture comme payée et ne
          pourra donc plus être modifier ou supprimer.
        </b>
      </p>
    </div>
  );
    ...
    <React.Fragment>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            onClick={props.enregistreFacturePayeDataBase}
...
export default EnregistreFacturePayeModal;
