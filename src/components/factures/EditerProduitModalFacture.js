...
class EditerProduitModalFacture extends Component {
  constructor(props) {
    super(props);
    const { indexLigneEditerProduitModalFacture } = this.props;
    const produitEdit = this.props.produitEdit.facture;
    console.log(produitEdit);
    this.state = {
      open: false,
      produit: {
        nom:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture]
            .produit,
        description:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture]
            .description,
        netUnitSalesPrice:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].prix,
        rate:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].tva,
        sku: produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].sku,
        unite:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].unite,
        id:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture]
            .produitId,
        authorId:
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      this.props.indexLigneEditerProduitModalFacture !==
        prevProps.indexLigneEditerProduitModalFacture
    ) {
      console.log(this.props.produitEdit);
      const { indexLigneEditerProduitModalFacture } = this.props;
      const produitEdit = this.props.produitEdit.facture;
      const produits = this.props.produits ? this.props.produits : [];
      console.log(produitEdit, indexLigneEditerProduitModalFacture);
      const produit = {
        nom:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture]
            .produit,
        ...
        rate:
          produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].tva,
        sku: produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].sku
          ? produitEdit.lignesFacture[indexLigneEditerProduitModalFacture].sku
      ...
      this.setState({ produit }, () => console.log(produit));
    }
  }
  handleSubmit = (event) => {
    event.preventDefault();
    if (this.state.produit.id) {
      const idx = this.props.indexLigneEditerProduitModalFacture;
      //alert('inside update');
