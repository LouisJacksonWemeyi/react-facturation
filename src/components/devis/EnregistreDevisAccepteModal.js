...
function EnregistreDevisAccepteModal(props) {
  const message = (
    <div class="alert alert-warning">
      ...
      <p class="text-info">
        <b>
          Cette action entraîne l'enregistrement du devis comme accepté et ne
    ...
    <React.Fragment>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            onClick={props.enregistreDevisAccepteDataBase}
...
export default EnregistreDevisAccepteModal;
