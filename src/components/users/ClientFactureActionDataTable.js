...
class ClientFactureActionDataTables extends Component {
  state = {
    TRfacture: this.props.factureToGenerate,
  ...
  render() {
    ...
    const tRow = TRfacture.map((tr) => (
      <tr id={'tr-' + tr.id.toString()} key={tr.id}>
        ...
        <td>
          ...
          <a href={'/clientFactureFinal/' + tr.id + '?authorId=' + tr.authorId}>
            <i
    ...
    return (
      <div className="col-sm-12">
        ...
        <h2>Téléchargez ou consultez la facture</h2>
        <table
...
export default ClientFactureActionDataTables;
