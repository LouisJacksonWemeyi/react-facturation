...
const ClientSignedInLinks = props => {
  return (
      ...
      {/* <li className="nav-item">
        <Link to="/facture/new" className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">New Facture</span>
          </div>
        </Link>
      </li>
      <li className="nav-item">
        <Link to="/devis" className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">Devis</span>
          </div>
        </Link>
      </li>
      <li className="nav-item">
        <Link to="/clients" className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">Clients</span>
          </div>
        </Link>
      </li>
      <li className="nav-item">
        <Link to="/produits" className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">Produits</span>
          </div>
        </Link>
      </li>
      <li className="nav-item">
        <Link to="/compte/profile" className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">Parametres</span>
          </div>
        </Link>
      </li> */}
      <li className="nav-item">
        <Link to="#" onClick={props.signOut} className="nav-link">
          <div className="navbar-brand">
            ...
            <span className="customizable-nav__label">Log Out</span>
          </div>
        </Link>
      </li>
      <li className="nav-item">
...
export default connect(null, mapDispatchToProps)(ClientSignedInLinks);
