...
function DeleteProduitModal(props) {
  return (
    <React.Fragment>
      <Modal
        show={props.show}
      ...
      >
        ...
        <Modal.Body>
          <div class="alert alert-danger">
            ...
            <p class="text-danger">
              <b>
                Cette action entraîne la suppression définitive du produit ainsi
                que toutes ses données , y compris les données imbriquées.
              </b>
            </p>
          </div>
          <p class="text-danger">
        ...
        <Modal.Footer>
          ...
          <Button
            onClick={props.deleteProduitDataBase}
