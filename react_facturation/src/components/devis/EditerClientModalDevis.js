...
class EditerClientModalDevis extends Component {
  constructor(props) {
    super(props);
    const clientEdit = this.props.clientEdit.devis;
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.clientEdit !== prevProps.clientEdit) {
      console.log(this.props.clientEdit);
      const clientEdit = this.props.clientEdit.devis;
